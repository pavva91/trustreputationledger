...
func getServiceRelationAgentByServiceWithCostAndTime(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// ==== Get the Agents for the byService query result ====
	serviceRelationSlice, err := getServiceRelationSliceFromByServiceQuery(byServiceQueryIterator,stub)
	if err != nil{
		return shim.Error(err.Error())
	}
...
// ============================================================================================================================
// Get Service Agent Relation - get the service agent relation asset from ledger (error!=nil ---> key not found)
// ============================================================================================================================
func getServiceRelationAgent(stub shim.ChaincodeStubInterface, relationId string) (ServiceRelationAgent, error) {
	...
	if serviceRelationAgentAsBytes == nil {
		return ServiceRelationAgent{}, errors.New("Service non found, ServiceId: " + relationId)
	}
